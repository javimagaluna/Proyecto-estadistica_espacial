...
Se propuso el modelo completo con las variables comunales HACI, MASCU, ESCU y Pob_Viv. Luego se fueron eliminando variables teniendo presente la significancia que tenían en el modelo completo y usando como criterio de eliminación el AIC.
...
Ahora veamos la correlación de los datos a traves de un corrplot ¿Qué tan relacionadas linealmente estarán nuestras variables?

```{r , fig.align="center", fig.cap= "Figura 2: Corrplot"}

knitr::include_graphics(here::here("Informe","Corrplot.png"))

```

De la Figura 2, podemos notar que las variables `POB`,`VIV`, `ABUSO`, `VIO.MUJ` y `VIO.NIN` poseen una asociación muy alta. Podriamos decir que a medida que hay mayor población o viviendas, encontraremos una mayor cantidad de denuncias con respecto a la violencia y abuso.
